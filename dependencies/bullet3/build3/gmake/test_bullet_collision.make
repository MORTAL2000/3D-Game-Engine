...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake.exe
  DEFINES   += 
...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake_debug.exe
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../test/collision -I../../src -I../../test/gtest-1.7.0/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake_x64_release.exe
  DEFINES   += 
  INCLUDES  += -I../../test/collision -I../../src -I../../test/gtest-1.7.0/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/test_bullet_collision_gmake_x64_debug.exe
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../test/collision -I../../src -I../../test/gtest-1.7.0/include
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
