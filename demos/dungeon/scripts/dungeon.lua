...
function onInit()
	...
	walls:setValue("hasNormalMap", 1)
	walls:setValue("normalMap", "bricks_normal")

	floor = Material("floor")
	floor:setValue("texture", "floor_diffuse")
	floor:setValue("textured", 1)
	floor:setValue("hasNormalMap", 1)
	floor:setValue("normalMap", "floor_normal")
