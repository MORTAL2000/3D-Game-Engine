...
ifeq ($(config),release32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaCompiler_gmake.exe
  DEFINES   += 
...
ifeq ($(config),debug32)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaCompiler_gmake_debug.exe
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../btgui/lua-5.2.3/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),release64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaCompiler_gmake_x64_release.exe
  DEFINES   += 
  INCLUDES  += -I../../btgui/lua-5.2.3/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
...
ifeq ($(config),debug64)
  ...
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/App_LuaCompiler_gmake_x64_debug.exe
  DEFINES   += -D_DEBUG=1
  INCLUDES  += -I../../btgui/lua-5.2.3/src
  CPPFLAGS  += -MMD -MP $(DEFINES) $(INCLUDES)
